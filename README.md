...
Plus **[`docs/`](docs/)** — whitepaper, architecture deep-dive, [**API reference**](docs/api.md), glossary, lineage essay. **[`lore/`](lore/)** — cultural artefacts of the project (the visual sigil codex, autogenesis doctrine). And **[`scripts/`](scripts/)** — utility scripts (e.g. the whitepaper PDF renderer).
