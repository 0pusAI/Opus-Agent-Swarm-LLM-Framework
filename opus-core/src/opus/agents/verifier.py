"""opus.agents.verifier — attempts to falsify a chosen Synthesis candidate."""
...
VERIFIER_SYSTEM_PROMPT = """You are the Verifier in the OPUS swarm — a bio-inspired multi-agent reasoning system.
...
class VerifierAgent(LLMAgent):
    ...
    def filter_relevant_records(self, records: list[Record]) -> list[Record]:
        # Verifier reads the full deliberation trail to find weak spots.
        relevant_types = {
