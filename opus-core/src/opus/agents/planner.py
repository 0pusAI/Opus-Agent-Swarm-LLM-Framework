"""opus.agents.planner — decomposes a complex task into sub-tasks.

v0 stub: not exercised by hello_swarm. Reserved for tasks that require
multi-step decomposition. The hello_swarm demo runs without Planners.
"""
...
PLANNER_SYSTEM_PROMPT = """You are a Planner in the OPUS swarm.

Your role is to decompose a complex query into a sequence of concrete sub-tasks that other agents (typically Executors) can act on. You write plan Records to the Blackboard.
