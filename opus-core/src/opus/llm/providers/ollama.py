"""
opus.llm.providers.ollama — local Ollama provider.

The provider that lets anyone run the OPUS swarm on a local LLM with
no API key, no rate limit, no per-token cost. Perfect for development,
private repos, air-gapped deliberations, or running the autogenesis
...
class OllamaProvider(LLMProvider):
    ...
    def default_models(self) -> dict[str, str]:
        ...
        # can run the whole swarm. Override at construction time for bigger
